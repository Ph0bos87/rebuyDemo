...
<head>
    ...
    <meta name="description" content="Rebuy stars - Bronze jackpot">
    ...
    <style>
        ...
        * {
		...
		#red-orange-brown {
			...
			text-align: center;
			font-size: 20px;
  background-image: -webkit-linear-gradient(TOP, #CA822C, #F6C656 50%, #CA822C);
  background-image: -o-linear-gradient(TOP, #CA822C, #F6C656 50%, #CA822C);
  background-image: linear-gradient(to bottom, #CA822C, #F6C656 30%, #CA822C, #F6C656);
  color: transparent;
...
<div id="wrapper">
	<span><span class="counter circle" style="display: inline-block; padding-right: 1px;">
		<?php
				$homepage=file_get_contents('https://kirota.hr/jackpots_bronze_vz.php');
				echo $homepage;
		?>
		</span></span>
